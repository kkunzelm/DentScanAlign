...
// Returns the vertices that belong to a specific region around a single seed.
// This is useful for DentScanAlign's landmark-based workflow.
std::vector<VertexDesc> getRegionVertices(
    const ScanData& scan,
